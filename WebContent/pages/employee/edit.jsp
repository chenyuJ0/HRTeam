...
<body style="padding:20px">
    ...
    <table>
        <tr style="height:50px">
            ...
            <td><input type="text" class="textbox textbox_225" value="张三" /></td>
            <td style="text-align:right"><span class="item_name">身份证号码：</span></td>
            <td><input type="text" class="textbox textbox_225" value="1234567876543" /></td>
        </tr>
        <tr style="height:50px">
            ...
            <td><input type="text" class="textbox textbox_225" disabled="disabled" value="1988-8-8" /></td>
        </tr>
        <tr style="height:50px">
        ...
        <tr style="height:50px">
            ...
            <td><input type="text" class="textbox textbox_225" value="2016-1-1" /></td>
            <td style="text-align:right"><span class="item_name">介绍人：</span></td>
            <td><input type="text" class="textbox textbox_225" value="李四" /></td>
        </tr>
        <tr>
            <td style="text-align:right"><span class="item_name">备注：</span></td>
            <td colspan="3">
                <textarea placeholder="备注信息" class="textarea" style="width:580px;height:100px;">电话确认周一来公司办理入职手续</textarea>
            </td>
        </tr>
        <tr style="height:50px">
            <td></td>
