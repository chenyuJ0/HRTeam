...
<html>
	...
	<body>
		<form class="layui-form" method="POST" id="deptForm"  action="${ctx}/notice/addNotice">
				<table  style="width:50%" >
						...
						<tr style="height:50px" >
							<td><label for="phone" class="layui-form-label"><span class="x-red">*</span>创建日期</label>
							</td>
							<td><input type="date" id="remark" name="create_date" required="" lay-verify="required"
                  				autocomplete="off" class="layui-input" value="${notice.create_date }">
                			</td>
						</tr>	
