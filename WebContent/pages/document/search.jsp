...
<html>
  ...
  <body>
    <div class="x-nav">
      ...
      <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${ctx }/doc/showAll/" title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
    </div>
    <div class="x-body">
      <div class="layui-row" style="" align="center">
        <form class="layui-form layui-col-md12 x-so" method="post" action="${ctx }/doc/search">
 ...
 <!--        <button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>批量删除</button> -->
      ...
      <table class="layui-table">
        ...
        <tbody>
        <c:forEach items="${info }" var="doc" varStatus="stat">
           ...
           <!--  <td class="td-status">
            ...
            <td class="td-manage">
             <!--  <a onclick="member_stop(this,'10001')" href="javascript:;"  title="启用">
              ...
              <a title="编辑"  href="${ctx}/doc/edit?id=${doc.id }">
                <i class="layui-icon">&#xe642;</i>
              </a>
